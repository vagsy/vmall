    ...
    <div class="navbar">
      <div class="navbar-left-container">
        <a href="/">
          ...
          <h2 style="color:#d1434a;">vmall</h2>
        </a>
      </div>
    			...
    			<div class="confirm-tips">
    				...
    				<ul>
    					<li class="regi_form_input">
    						...
    						<input type="text" tabindex="1" name="loginname" v-model="userName" placeholder="用户名"
    						data-type="loginname" class="regi_login_input regi_login_input_left">
    					</li>
    					<li class="regi_form_input noMargin">
    						<i class="icon IconPwd"> </i>
    						<input type="password" tabindex="2" v-model="userPwd" name="password" placeholder="密码" @keyup.enter="login"
